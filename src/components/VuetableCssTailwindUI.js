export default {
  table: {
    ...
    thead: "bg-tertiary-100",
    tbody: "divide-y divide-tertiary-200 bg-white",
    table: "min-w-full divide-y divide-gray-300",
    th: "hidden px-3 py-smSpace text-left text-sm font-medium lg:table-cell text-tertiary-700",
